...
import com.everis.examen2academia.Examen2AcademiaApplication;
...
@SpringBootTest(classes = Examen2AcademiaApplication.class) // clase principal de la aplicacion
@WebAppConfiguration
public class ProductoControllerTest {
	...
	public void testConsultarProductos() throws Exception {
		String url = "/productos/busqueda?productoBuscado=prue";
	...
	public void testInsertar() throws Exception {
		...
		MvcResult resultado = mvc.perform(MockMvcRequestBuilders.post(url).contentType(MediaType.
				APPLICATION_JSON_VALUE).content(json)).andReturn();
